...
const setupAuthRoutes = require('./server-endpoints/auth.js');
const setupFileRoutes = require('./server-endpoints/files.js');
const setupProjectRoutes = require('./server-endpoints/projects.js');
const setupUserRoutes = require('./server-endpoints/users.js');
const setupTaskRoutes = require('./server-endpoints/tasks.js');
const setupWebSocket = require('./server-endpoints/websocket.js');
const setupInstallerRoutes = require('./server-endpoints/installer.js');
const setupClientRoutes = require('./server-endpoints/clients.js');
const setupEmployeeRoutes = require('./server-endpoints/employees-module.js');
const setupSalesRoutes = require('./server-endpoints/sales.js');
const setupWorkspaceRoutes = require('./server-endpoints/workspaces-module.js');

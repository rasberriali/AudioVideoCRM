  ...
  private async syncWithServer(): Promise<void> {
    try {
      ...
      try {
        ...
        console.log('[LOCAL_STORE] Workspaces sync failed, using local data');
      }
      ...
      try {
        ...
        console.log('[LOCAL_STORE] Clients sync failed, using local data');
      }
      ...
      try {
        ...
        console.log('[LOCAL_STORE] Server not available, using local data');
      }
